...
#btn1.grid(row=0, column=0)  # 0,0 위치에 배치
...
btn_f16.grid(row=0, column=0, sticky = N+E+W+S, padx=3, pady=3)  #sticky: 빈 공간을 북동서남으로 가득 채워
btn_f17.grid(row=0, column=1, sticky = N+E+W+S, padx=3, pady=3)  #grid에 padx/pady: 버튼이 위치한 기준으로 3씩 x / y를 늘린다.
...
btn_0.grid(row=5, column=0, columnspan=2, sticky = N+E+W+S, padx=3, pady=3)  # columnspan: 현재 위치로부터 오른쪽을 몇 줄을 더함
